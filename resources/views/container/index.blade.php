<x-layout>
    <div class="flex-grow-1 d-flex flex-column container pt-3">
        <h5 class="fw-bold mb-3">Kontainer</h5>

        <div class="flex-grow-1 d-flex justify-content-center align-items-center">
            <div class="col-10 col-md-3 d-flex flex-column gap-3">
                <button type="button" id="scanBtn" class="btn btn-primary w-100">
                    <i class="bi bi-qr-code-scan"></i> Scan QR Code
                </button>
                <a href="{{ route('container.search') }}" class="btn btn-primary w-100">
                    <i class="bi bi-search"></i> Cari Barang
                </a>
                <a href="{{ route('container.create') }}" class="btn btn-primary w-100">
                    <i class="bi bi-plus-circle"></i> Buat Kontainer
                </a>
            </div>
        </div>
    ...
    <script>
        ...
        async function onScanSuccess(decodedText) {
            ...
            if (linkMatches && linkMatches.length > 0) {
                ...
                const kodeRegex = /(?:asset\/index\.php\?id=|container\/)([^"\s/]+)/i;
                ...
                if (kodeMatches && kodeMatches.length > 0) {
                    ...
                    const ContainerUrl = "{{ route('container.show', 'kode') }}";
                    window.location.href = ContainerUrl.replace('kode', kode);
                } else {
