        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex flex-column align-items-center">
                    ...
                    @if ($ticket['is_stale'] && in_array($ticket['status'], ['Baru', 'Proses']))
                    <span class="badge rounded-pill bg-warning text-bg-warning">
                        {{ $ticket['days_unmodified'] }} Hari Tanpa Update
                        <span class="visually-hidden">Need Followup</span>
                    </span>
                    @endif
                </div>
            </div>
